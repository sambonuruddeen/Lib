		...
		<div class="container">
			<form class="search-form domain-search" action="#" method="post">
				<div class="two-fifth column first">
					<h2>Search Library <span>Collections</span></h2>
				</div>
				<div class="three-fifth column first">
					<input type="text" class="text" name="Name" placeholder="Enter Search Here" required>               
				</div>
				  ...
				  <ul>
					...
					<li>
						<div class="pricing">
							...
							<div class="pricing-bottom">
								<div class="pricing-bottom-top">
									<p>Education Foundation</p>
									<p>Science Education</p>
									<p>Vocational & Technology Education</p>
								</div>
								<div class="pricing-bottom-bottom">
									<p><span>6500 </span> Articles</p>
									<p><span>75</span> Research Papers</p>  
				...
				<div class="w3-agileits-choose">
					<div class="col-md-6 choose-grid">
						<div class="w3-banner-bottom-heading choose-heading">
							<h3>Our Collections<span></span></h3>
						</div>
	...
	<div class="subscribe">
		<div class="container">
			<div class="w3-banner-bottom-heading">
				...
				<span class="news">News Heading 1</span>
				<p>Pellentesque urna ex, ultricies a nunc at,
				pretium maximus nisi. Vestibulum non auctor
				diam. Mauris eget... <a href="#">Read More</a></p>
				</div>
				
				<div class="col-md-4 services-grid-left">
				<span class="news">News Heading 2</span>
				<p>Pellentesque urna ex, ultricies a nunc at,
				pretium maximus nisi. Vestibulum non auctor
				diam. Mauris eget... <a href="#">Read More</a></p>
				</div>
				...
				<div class="col-md-4 services-grid-left">
				<span class="news">News Heading 3</span>
				<p>Pellentesque urna ex, ultricies a nunc at,
				pretium maximus nisi. Vestibulum non auctor
				diam. Mauris eget... <a href="#">Read More</a></p>
				</div>
